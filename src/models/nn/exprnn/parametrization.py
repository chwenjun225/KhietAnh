...
class Parametrization(nn.Module):
    ...
    def __init__(self, A, base, mode):
        ...
        mode: "static" or a tuple such that:
                ...
                mode[2]: int, M, the number of changes of basis after which we should project back onto 
                    the manifold the basis. This is particularly helpful for small values of K.
        """
